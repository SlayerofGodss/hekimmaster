...
import { RandevuComponent } from 'app/entities/randevu/randevu.component';
import { RandevuService } from 'app/entities/randevu/randevu.service';
import { Randevu } from 'app/shared/model/randevu.model';

describe('Component Tests', () => {
  describe('Randevu Management Component', () => {
    let comp: RandevuComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RandevuComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.randevus && comp.randevus[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
