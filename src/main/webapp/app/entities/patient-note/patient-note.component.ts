...
export class PatientNoteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.patientNoteService
      ...
      .subscribe(
        (res: HttpResponse<IPatientNote[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPatientNotes(): void {
    this.eventSubscriber = this.eventManager.subscribe('patientNoteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPatientNote[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/patient-note'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
