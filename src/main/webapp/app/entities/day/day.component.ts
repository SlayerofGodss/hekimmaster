...
export class DayComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.dayService
      ...
      .subscribe(
        (res: HttpResponse<IDay[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDays(): void {
    this.eventSubscriber = this.eventManager.subscribe('dayListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDay[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
